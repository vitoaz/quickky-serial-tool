...
class SettingsDialog(QDialog):
    def __init__(self, parent, config_manager):
        ...
        buttons = QDialogButtonBox(QDialogButtonBox.Ok | QDialogButtonBox.Cancel); buttons.accepted.connect(self._save); buttons.rejected.connect(self.reject); layout.addRow(buttons)
    @staticmethod
