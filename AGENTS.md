...
- `scripts/`：存放版本信息生成、发布许可证、发布包和 PyInstaller 裁剪钩子。
...
- 版本发布遵循 `docs/guides/version-release.md` 的双 SOP：
  ...
  - `SOP 2：提交与 GitHub Release`：仅在用户明确要求“提交”后，才可提交、合并、打标签、推送和创建 GitHub Release；仅正式发布完成后，按 SOP 自动提交下一 Snapshot 开发版本。
