...
class WorkTab(QWidget):
    ...
    def _build_ui(self):
        ...
        left = QWidget(); left_layout = QVBoxLayout(left); left_layout.setContentsMargins(4, 4, 4, 4)
        ...
        splitter = QSplitter(Qt.Horizontal); splitter.addWidget(left); splitter.addWidget(right); splitter.setStretchFactor(1, 1)
